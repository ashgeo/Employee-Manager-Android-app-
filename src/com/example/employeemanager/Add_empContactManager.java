...
public class  Add_empContactManager extends Activity
{
	SQLiteDatabase db;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		
		{
			...
			public void onClick(View v)
			{
				...
				db.execSQL("UPDATE  Employee  SET work_ph = '"+wphone+"',home_ph='"+homphone+"', hand_ph='"+haphone+"',email='"+cemail+"',post_address='"+paddress+"',post_code='"+pcode1+"',home_address='"+homaddress+"',hpost_code='"+pcode2+"' WHERE emp_code='"+ empcode + "'");   
                db.close();	
				
				
				
				startActivity(new Intent( Add_empContactManager.this,Add_empOtherManager.class) );
			}
