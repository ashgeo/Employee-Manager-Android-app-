...
public class Add_empOtherManager extends Activity  implements OnItemSelectedListener
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		
		{
			...
			{		
				...
				db.execSQL("UPDATE  Employee  SET nric_fin = '"+fricfin+"',pr_citizen='"+prorcitizen+"',pr_start_date='"+prstrtdate+"',pr_type='"+prtypes+"',year_of_pr='"+yrofpr+"' WHERE emp_code='"+ empcode + "'");   
                db.close();
				
				
				 AlertDialog.Builder builder = new AlertDialog.Builder(Add_empOtherManager.this);
				    ...
				    builder.setPositiveButton("OK",new DialogInterface.OnClickListener()
				    {
				     public void onClick(DialogInterface dialog, int which)
				     {
				    	 ...
				    	 startActivity(new Intent(Add_empOtherManager.this,Home.class) );
				     }
				    });	    
     ...
     public void onDateSet(DatePicker view, int year,  int monthOfYear, int dayOfMonth)  
     {
      ...
      // TODO Auto-generated method stub
       date = String.valueOf(dayOfMonth)  + 
        ...
        "/ " +String.valueOf(year) ;
      Toast.makeText(Add_empOtherManager.this, date, 
