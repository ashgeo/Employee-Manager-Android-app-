...
public class Add_new_emp_details extends Activity implements OnItemSelectedListener
{
	SQLiteDatabase db;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		
		{
			...
			
			{
				...
				db.execSQL("UPDATE  Employee  SET jtitle = '"+jbtitl+"',dep='"+dp+"',emp_grp='"+empgrp+"' WHERE username='"+ name + "'");   
                db.close();
		
				
				startActivity(new Intent(Add_new_emp_details.this,Add_new_emp_contact.class) );
			}
